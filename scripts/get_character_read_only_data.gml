///get_character_read_only_data([Script]onComplete, [Script]onError, [String]playFabId, [String]characterId, [List]keys, [Int]ifChangedFromDataVersion);
...
// Path
var path = "/GetCharacterReadOnlyData";
